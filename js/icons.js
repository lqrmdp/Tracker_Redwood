/* ============================================================
   ...
   (sustituyen a lucide-react). Usa React global para el JSX.
   Publica en window.RW: Icon, I
   ============================================================ */
(function () {
  const Icon = ({ path, className = "w-4 h-4", ...rest }) => (
  ...
  const I = {
    ...
    Flask:  <><path d="M9 3h6M10 3v6.5L4 20a2 2 0 0 0 1.73 3h12.54A2 2 0 0 0 20 20l-6-10.5V3"/></>,
    Lock:   <><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></>,
  };

  window.RW = Object.assign(window.RW || {}, { Icon, I });
})();
